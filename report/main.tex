...
Figure~\ref{fig:constraints} shows both on the running example. Springs on the left pull beads outward toward the pins. The volcano on the right pushes beads away, and that side of the contour bends inward.

\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{constraints2.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{iteration.png}
